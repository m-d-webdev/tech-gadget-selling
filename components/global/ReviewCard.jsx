        ...
        <div className={`${className} relative shadow-sm bg-background flex flex-col justify-between p-4 w-full rounded-xl`}>
            ...
            <div className="mt-6">
                ...
                <div className="w-full  flex items-start gap-4 mt-4">
                    <img src={data.user?.image} className="w-[48] h-[48] border border-chart-1/50 rounded-full object-cover" alt="" />
                    <div className="">
                        <h2 className="font-semibold text-lg tracking-tight">{data.user?.name}</h2>
                        <p className="text-xs  opacity-70">{data.date}</p>
                    </div>
                </div>
            </div>
